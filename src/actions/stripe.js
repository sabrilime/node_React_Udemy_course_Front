...
export const creacteConnectAccount = async (token) => 
    await axios.post(`${process.env.REACT_APP_API}/creacte-connect-account`, {}, {
        headers: {
...
export const payoutSetting = async (token) => await axios.post(
